export const siteConfig = {
  ...
  description:
    "FoerKoeq presents you with the most powerful, simplest, and fastest developer-friendly and highly customizable React, Vue 3, and Tailwind templates to build web UI for your app.",
  links: {
    twitter: "#",
    github: "#",
  },

          ...
          submenus: [
            {
              ...
              label: "Manajemen Lokasi Gudang",
              active: pathname.includes("/data-management/storage"),
              icon: "heroicons-outline:building-office",
              submenus: [],
              children: [],
            },
            {
              href: "/data-management/medicine-ids",
              label: "Manajemen ID & QR Code Obat",
              active: pathname.includes("/data-management/medicine-ids"),
              icon: "heroicons-outline:queue-list",
              submenus: [],
              children: [],
            },
            {
              href: "/data-management/print-history",
              label: "Riwayat Cetak",
              active: pathname.includes("/data-management/print-history"),
              icon: "heroicons-solid:printer",
              submenus: [],
              children: [],
            },
            {
              href: "/data-management/activity-log",
              label: "Riwayat Aktifitas",
              active: pathname.includes("/data-management/activity-log"),
